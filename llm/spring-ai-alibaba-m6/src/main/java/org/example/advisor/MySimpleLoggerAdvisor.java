...
public class MySimpleLoggerAdvisor implements CallAroundAdvisor, StreamAroundAdvisor {
    ...
    public static final Function<ChatResponse, String> DEFAULT_RESPONSE_TO_STRING = (response) -> ModelOptionsUtils.toJsonString(response);
    ...
    public MySimpleLoggerAdvisor(Function<AdvisedRequest, String> requestToString, Function<ChatResponse, String> responseToString, int order) {
